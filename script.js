...
const mascota = "serpiente";
if (mascota === "serpiente") {
...
const resultado = (clima === "soleado") ? "Me vestiré con un vestido" : "Me vestiré con pantalón";
...
//Escribe tu código aquí
// Esto imprimirá los números del 0 al 10 en la consola
for (let i = 0; i <= 10; i++) {
  console.log(i);
}
...
console.log(calcularAreaRectangulo(4, 4));
